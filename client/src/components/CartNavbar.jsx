                    ...
                    <ul className="dropdown-menu dropdown-menu-end shadow p-2" style={{ minWidth: '280px' }}>
                        {cart.length === 0 ? (
                            ...
                            <>
                                ...
                                <li className="fw-bold pt-2 text-end"><div className="cheackout-stats"><a className="nav-link cheackout" href="/checkout">Check out</a><p className="cheackout">Totalt: {total}:-</p></div></li>
                            </>
                        )}
                    </ul>
                </div>
